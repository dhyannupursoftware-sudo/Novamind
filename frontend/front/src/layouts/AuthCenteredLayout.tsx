...
export function AuthCenteredLayout({ children }: AuthCenteredLayoutProps) {
  return (
    <main className="relative min-h-screen w-full flex items-center justify-center bg-[#08090b] text-white px-3 sm:px-4 py-8 sm:py-12 overflow-x-hidden selection:bg-indigo-500/30 selection:text-white">
      ...
      <div className="relative z-10 w-full max-w-[440px] flex flex-col items-center">
        ...
        <motion.div
          ...
          className="w-full rounded-[28px] sm:rounded-[30px] border border-white/[0.06] bg-[#101114]/75 backdrop-blur-3xl px-5 sm:px-8 py-7 sm:py-10 shadow-[0_24px_50px_-12px_rgba(0,0,0,0.6)] flex flex-col text-center"
        >
          {children}
        </motion.div>
